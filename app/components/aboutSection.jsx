    ...
    >
      <div className="col-span-9 max-md:col-span-full">
        ...
        <p className="text-[18px] max-2xl:text-[16px] max-md:text-[14px] text-[#F5F5F5]">
          ...
          organizing orientations and training programs. Known for my
          approachable, diplomatic, and discerning nature, I excel in employee
          relations and am committed to enhancing employee retention and
          fostering a positive company culture. My career goal is to leverage my
          skills and knowledge in an organization that values continuous growth
          and professional development. I am proficient in HR and Corporate
          Services roles, eager to further develop my abilities, and contribute
          effectively to both organizational and personal success.
        </p>
